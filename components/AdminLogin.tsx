       ...
       >
          ...
          <form onSubmit={handleAdminLogin} className="space-y-6">
             <div className="space-y-2">
                <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest mr-4">كود الوصول</label>
                <input 
                  required 
                  type="text" 
                  value={email} 
             ...
             <div className="space-y-2">
                <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest mr-4">المفتاح المشفر</label>
                <input 
                  required 
                  type="password" 
                  value={password} 
