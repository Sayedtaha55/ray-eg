...
const OfferCard: React.FC<OfferCardProps> = ({ offer, idx, navigate, setSelectedItem, playSound }) => {
  ...
  return (
    /*
      Optimize OfferCard by using SmartImage for lazy loading and skeleton states.
      The idx check ensures the first item is loaded eagerly with high priority.
    */
    <div
      ref={setRef}
    ...
    >
      ...
      >
        <SmartImage
          ...
          imgClassName="object-cover group-hover:scale-110 transition-transform duration-[2s]"
        />
