...
const HomeFeed: React.FC = () => {
  ...
  // BOLT OPTIMIZATION: Memoize navigation and state updates to prevent unnecessary re-renders
  // of expensive child components like StorefrontShowcaseSection and OffersSection.
    ...
    <div className="max-w-[1400px] mx-auto px-4 md:px-8 py-4 md:py-12 relative">
      ...
      <Suspense fallback={<div className="min-h-[55vh]" /> }>
        <OffersSection
          ...
          loadMoreOffers={useCallback(() => loadMoreOffersRef.current?.(), [])}
        />
      </Suspense>
