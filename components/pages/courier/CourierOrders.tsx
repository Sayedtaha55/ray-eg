      ...
      {drawerOpen && (
        <div className="fixed inset-0 z-[200] md:hidden">
          <button
            ...
            aria-label="close"
          />
          <div className="absolute top-0 bottom-0 right-0 w-[85%] max-w-sm bg-slate-900 border-l border-white/10 p-6 overflow-y-auto">
          ...
          <div className="max-w-6xl mx-auto px-4 md:px-8 py-6 md:py-10 space-y-6 md:space-y-10">
            <div className="flex items-start md:items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-2 md:gap-3">
                ...
                <button
                  onClick={handleLogout}
                  className="inline-flex items-center gap-2 px-3 py-2 md:px-4 md:py-3 rounded-2xl bg-red-500/10 hover:bg-red-500/15 text-red-300 text-xs md:text-sm font-black"
                >
                  <LogOut size={14} />
                  خروج
                </button>
