/**
 * MockDatabase - Fallback Layer for Offline Mode
 * 
 * This is a temporary in-memory fallback used when the backend is unavailable.
 * It should NOT be used as a primary data store.
 * 
 * TODO: Consider replacing with a proper offline-first solution (e.g., IndexedDB, PWA sync)
 */
class MockDatabase {
  private shops: any[] = [];
