              ...
              {id === 'minimal' ? (
                <div className="w-28 h-20 overflow-hidden relative shrink-0 transition-transform duration-300 group-hover:scale-[1.03]">
                  ...
                  <div className="absolute inset-x-0 bottom-0 h-8 px-2 py-1 flex flex-col items-end justify-center">
                    <div className="h-2 w-14 bg-slate-900/70 rounded-full" />
                ...
                <div className="w-28 h-20 rounded-2xl overflow-hidden bg-white p-2 space-y-2 shrink-0 transition-transform duration-300 group-hover:scale-[1.03]">
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-2 gap-3">
          <button
            ...
            className={`p-4 rounded-2xl border transition-all ${layoutMode === 'vertical' ? 'border-[#00E5FF] bg-slate-50' : 'border-slate-100 hover:border-slate-200'}`}
          >
          ...
          <button
            ...
            className={`p-4 rounded-2xl border transition-all ${layoutMode === 'horizontal' ? 'border-[#00E5FF] bg-slate-50' : 'border-slate-100 hover:border-slate-200'}`}
          >
            <div className="aspect-square bg-slate-100 rounded-xl mb-3 overflow-hidden">
              <div className="w-full h-full flex items-center justify-center">
                <span className="text-2xl">➡️</span>
