...
export class ShopSitemapService {
  ...
  async generateSitemap(): Promise<string> {
    ...
    // Performance Optimization: Parallelize independent Prisma queries using Promise.all
    // to minimize sitemap generation request latency and database roundtrips.
