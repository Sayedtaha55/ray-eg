...
function getComputedStyles(node: ComponentNode, theme: BuilderWebsite['theme']): React.CSSProperties {
  ...
  const css: React.CSSProperties = {
    display: d.display as any,
    flexDirection: d.flexDirection as any,
    justifyContent: d.justifyContent as any,
    alignItems: d.alignItems as any,
    flexWrap: d.flexWrap as any,
    ...
    fontFamily: d.fontFamily || theme?.typography?.fontBody || 'Cairo, sans-serif',
    fontSize: d.fontSize,
    fontWeight: d.fontWeight as any,
    lineHeight: d.lineHeight,
    letterSpacing: d.letterSpacing,
    textAlign: d.textAlign as any,
    color: d.textColor,
    textTransform: d.textTransform as any,
    backgroundColor: d.backgroundColor,
    backgroundImage: d.backgroundImage,
    backgroundSize: d.backgroundSize,
    backgroundPosition: d.backgroundPosition,
    borderWidth: d.borderWidth,
    borderStyle: d.borderStyle as any,
    borderColor: d.borderColor,
    borderRadius: d.borderRadius,
    boxShadow: d.boxShadow,
    opacity: d.opacity as any,
    backdropFilter: d.backdropBlur ? `blur(${d.backdropBlur})` : undefined,
    WebkitBackdropFilter: d.backdropBlur ? `blur(${d.backdropBlur})` : undefined,
    overflow: d.overflow as any,
    position: d.position as any,
    top: d.top,
    right: d.right,
    bottom: d.bottom,
    left: d.left,
    zIndex: d.zIndex as any,
  };
