    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          ...
          <p className="text-slate-500 dark:text-slate-400 font-semibold text-sm">انضم لمنصة من مكانك الآن</p>
        </div>
        ...
        <form className="space-y-4" onSubmit={async (e) => {
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input type="text" value={name} onChange={(e) => setName(e.target.value)} className="w-full bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl pr-12 pl-4 py-4 font-semibold focus:border-brand-cyan outline-none transition-colors" placeholder="اسمك" />
            </div>
          </div>
          <div>
        ...
        <div className="text-center mt-6">
          <Link href="/login" className="block text-brand-cyan font-semibold text-sm hover:underline">لديك حساب؟ سجل دخولك</Link>
