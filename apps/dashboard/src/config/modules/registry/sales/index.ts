  ...
  navigation: [
    {
      ...
      items: [
        ...
        { id: 'epayment', label: 'E-Payment', labelKey: 'business.dashboardTabs.epayment', route: '/business/dashboard?tab=epayment', tabId: 'epayment', icon: 'CreditCard', order: 7 },
        { id: 'orderStatus', label: 'Order Status', labelKey: 'business.dashboardTabs.orderStatus', route: '/business/dashboard?tab=orderStatus', tabId: 'orderStatus', icon: 'ListChecks', order: 8 },
      ],
    },
  ],
  dashboardWidgets: [
