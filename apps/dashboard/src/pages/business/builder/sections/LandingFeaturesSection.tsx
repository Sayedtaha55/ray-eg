...
import {
  Zap, Star, Truck, ShieldCheck, Package, Flame, Gift, Clock,
} from 'lucide-react';
...
const LandingFeaturesSection: React.FC<Props> = ({ config, setConfig }) => {
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-xs font-bold text-slate-500">اختر شارات الثقة (تحت الزر):</p>
