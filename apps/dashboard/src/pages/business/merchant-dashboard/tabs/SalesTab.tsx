...
type Props = { sales: any[]; posEnabled?: boolean; shop?: any };

const SalesTab: React.FC<Props> = ({ sales, posEnabled = false, shop }) => {
    ...
    <div className="bg-white p-4 sm:p-6 md:p-12 rounded-[2rem] md:rounded-[3.5rem] border border-slate-100 shadow-sm">
      <div className="flex flex-col gap-4 md:gap-6 mb-6 md:mb-10 md:flex-row md:items-center md:justify-between md:flex-row-reverse">
        <div className="text-right">
          <h3 className="text-xl sm:text-2xl md:text-3xl font-black">{activityVocab.salesTabLabel}</h3>
