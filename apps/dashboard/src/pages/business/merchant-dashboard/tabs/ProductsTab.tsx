        ...
        <div className="mb-6 flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full bg-slate-50 border border-slate-200 rounded-2xl py-3 sm:py-4 pr-12 pl-4 font-bold text-right outline-none focus:border-[#00E5FF] transition-colors"
            />
          </div>
          {categories.length > 0 && (
            <select
              ...
              className="bg-slate-50 border border-slate-200 rounded-2xl py-3 sm:py-4 px-4 font-bold text-right outline-none focus:border-[#00E5FF] transition-colors cursor-pointer"
            >
          ...
          <div className="relative">
            ...
            <select
              ...
              className="bg-slate-50 border border-slate-200 rounded-2xl py-3 sm:py-4 pr-10 pl-4 font-bold text-right outline-none focus:border-[#00E5FF] transition-colors cursor-pointer appearance-none"
            >
                ...
                {filteredProducts.length === 0 ? (
                  <div className="p-8 sm:p-12 text-center">
                    {searchQuery || categoryFilter !== 'all' ? (
                      <p className="text-slate-400 font-black text-sm sm:text-base">{t('business.dashboard.products.noSearchResults', { defaultValue: 'لا توجد نتائج مطابقة' })}</p>
                    ) : (
                      <p className="text-slate-400 font-black text-sm sm:text-base">{activityVocab.emptyProductsMessage}</p>
                    )}
                  </div>
                ) : (
