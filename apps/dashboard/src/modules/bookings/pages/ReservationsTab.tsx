    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white p-4 sm:p-6 rounded-xl border border-slate-200 shadow-sm">
          ...
          <p className="text-2xl sm:text-3xl font-bold text-slate-900">{counts.pending}</p>
          <p className="text-xs text-slate-500 font-semibold mt-1">{t('business.reservations.currency')} {stats.pendingRevenue.toLocaleString()} معلق</p>
        </div>
        ...
        <div className="bg-white p-4 sm:p-6 rounded-xl border border-slate-200 shadow-sm">
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className="text-xs font-semibold text-slate-500">مكتملة</span>
          </div>
          <p className="text-2xl sm:text-3xl font-bold text-slate-900">{counts.completed}</p>
          <p className="text-xs text-slate-500 font-semibold mt-1">{t('business.reservations.currency')} {stats.totalRevenue.toLocaleString()} إيرادات</p>
        </div>
        ...
        <div className="bg-white p-4 sm:p-6 rounded-xl border border-slate-200 shadow-sm">
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className="text-xs font-semibold text-slate-500">ملغاة / منتهية</span>
          </div>
          <p className="text-2xl sm:text-3xl font-bold text-slate-900">{counts.expired}</p>
        </div>
        ...
        <div className="bg-white p-4 sm:p-6 rounded-xl border border-slate-200 shadow-sm">
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className="text-xs font-semibold text-slate-500">حجوزات اليوم</span>
          </div>
          <p className="text-2xl sm:text-3xl font-bold text-slate-900">{stats.todayReservations}</p>
          <p className="text-xs text-slate-500 font-semibold mt-1">من {reservations.length} إجمالي</p>
        </div>
      </div>
