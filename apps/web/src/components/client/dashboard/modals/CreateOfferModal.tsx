...
const CreateOfferModal: React.FC<Props> = ({ isOpen, onClose }) => {
  const t = useT();
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
      <div className="bg-white w-full max-w-2xl rounded-[2.5rem] p-8 relative">
        ...
        <h2 className="text-2xl font-black text-slate-900 text-right mb-6">{t('business.promotions.createOffer')}</h2>
