...
const AddProductModalRouter: React.FC<Props> = ({ isOpen, onClose, shopId, shopCategory }) => {
  ...
  if (shopCategoryUpper === 'RESTAURANT') return <RestaurantAddProductModal isOpen={isOpen} onClose={onClose} shopId={shopId} shopCategory={shopCategory} />;
  if (shopCategoryUpper === 'FASHION') return <FashionAddProductModal isOpen={isOpen} onClose={onClose} shopId={shopId} shopCategory={shopCategory} />;
  if (shopCategoryUpper === 'RETAIL') { if (devActivityId === 'homeGoods') return <HomeGoodsAddProductModal isOpen={isOpen} onClose={onClose} shopId={shopId} shopCategory={shopCategory} />; return <HomeTextilesAddProductModal isOpen={isOpen} onClose={onClose} shopId={shopId} shopCategory={shopCategory} />; }
  if (shopCategoryUpper === 'FOOD') return <GroceryRetailAddProductModal isOpen={isOpen} onClose={onClose} shopId={shopId} shopCategory={shopCategory} />;
  if (shopCategoryUpper === 'FURNITURE') return <FurnitureAddProductModal isOpen={isOpen} onClose={onClose} shopId={shopId} shopCategory={shopCategory} />;
