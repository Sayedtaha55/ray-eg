    ...
    <div className="min-h-screen bg-slate-50 py-8 md:py-12">
      <div className="max-w-[1400px] mx-auto px-4 md:px-6">
        <div className="mb-8">
          ...
          <p className="text-slate-500 font-bold">اختر ثيماً لألوان وتصميم موقعك</p>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="p-4 flex items-center justify-between">
                  ...
                  <Link
                    href={`/dashboard/website/apply-theme?theme=${theme.id}`}
                    className="w-8 h-8 rounded-xl bg-blue-50 flex items-center justify-center hover:bg-blue-100 transition-all"
                  >
