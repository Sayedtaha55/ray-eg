      ...
      <div className="flex items-center gap-3 flex-1">
        ...
        <div className="relative hidden md:block">
          ...
          <input
            type="text"
            placeholder="بحث..."
            className="w-64 bg-white/10 border border-white/10 rounded-xl py-2.5 pr-10 pl-4 text-sm font-bold text-white placeholder:text-white/40 outline-none focus:bg-white/15 focus:border-[#00E5FF]/40 transition-all"
          />
        </div>
      </div>
        ...
        <div className="relative" ref={dropdownRef}>
          ...
          {dropdownOpen && (
            <div className="absolute left-0 mt-2 w-56 bg-white border border-slate-100 rounded-2xl shadow-xl py-2 z-50">
              ...
              <button
                onClick={() => router.push(sectionSettingsHref(pathname))}
