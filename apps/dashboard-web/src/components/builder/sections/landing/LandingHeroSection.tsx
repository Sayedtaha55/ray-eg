...
export default function LandingHeroSection({ config, onChange }: LandingHeroSectionProps) {
  ...
  return (
    <div className="space-y-4 text-right" dir="rtl">
      ...
      <div className="space-y-2">
        ...
        <input
          type="text"
          value={landing.ctaText || 'أضف للسلة'}
      ...
      <div className="space-y-2">
        ...
        <input
          type="text"
          value={landing.reserveText || 'احجز الآن'}
      ...
      <div className="space-y-2">
        ...
        <input
          type="text"
          value={landing.finalCtaText || 'احصل عليه الآن'}
