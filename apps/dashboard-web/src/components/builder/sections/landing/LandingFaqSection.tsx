...
export default function LandingFaqSection({ config, onChange }: LandingFaqSectionProps) {
          ...
          <div key={idx} className="p-3 rounded-xl border border-slate-100 space-y-2">
            <div className="flex items-center gap-2">
              <input
                ...
                className="flex-1 px-3 py-2 rounded-lg border border-slate-200 text-xs font-black"
                placeholder="السؤال"
              />
              <button
                type="button"
            ...
            <textarea
              ...
              className="w-full px-3 py-2 rounded-lg border border-slate-200 text-xs font-bold resize-none"
              rows={2}
              placeholder="الإجابة"
            />
          </div>
