...
export const sectionTemplates: SectionTemplate[] = [
  ...
  },
  {
    ...
    nameAr: 'فروع وصالات العرض في مصر',
    category: 'about',
    activity: 'general',
    style: 'corporate',
  ...
  // ==========================================
  // أقسام السوق المصري (شارات ثقة، أوقات عمل، شريط عروض)
  // مبنية كلياً من أنواع مدعومة في الكانفس والعارض العام
  // ==========================================
  {
    id: 'eg-trust-badges',
    name: 'eg-trust-badges',
    nameAr: 'شريط شارات الثقة (دفع عند الاستلام)',
    category: 'features',
    activity: 'general',
    style: 'modern',
  ...
  {
    id: 'eg-working-hours',
    name: 'eg-working-hours',
    nameAr: 'أوقات العمل والتواصل السريع',
    category: 'contact',
    activity: 'general',
    style: 'clean',
  ...
  },
  {
    id: 'eg-promo-bar',
    name: 'eg-promo-bar',
    nameAr: 'شريط عروض علوي (إعلان مختصر)',
    category: 'navbar',
    activity: 'general',
    style: 'modern',
  ...
  // ============================================
  // أقسام السوق المصري الجديدة
  // ============================================

  // شارات الثقة — trust badges
  {
    id: 'eg-trust-badges',
    name: 'trust-badges-egypt',
    nameAr: 'شارات الثقة (دفع عند الاستلام / توصيل)',
    category: 'features',
    activity: 'general',
    style: 'clean',
    wireframeType: 'trust-badges',
    descriptionAr: 'شارات ثقة مصرية: دفع عند الاستلام، توصيل سريع، ضمان الجودة، +1000 عميل.',
    ...
    nodes: {
      tmplt_trust_root: {
        ...
        props: {
          badges: [
            { icon: 'Truck', label: 'توصيل لجميع المحافظات', sub: 'خلال 2-5 أيام عمل' },
            { icon: 'CreditCard', label: 'دفع عند الاستلام', sub: 'بدون أي دفع مسبق' },
            { icon: 'ShieldCheck', label: 'ضمان الجودة', sub: 'استرداد كامل خلال 14 يوم' },
            { icon: 'Star', label: '+1,000 عميل سعيد', sub: 'تقييم ممتاز على المنصة' },
          ],
        },
        styles: {
          desktop: { backgroundColor: '#f8fafc', paddingTop: '32px', paddingBottom: '32px' },
          mobile: { paddingTop: '20px', paddingBottom: '20px' },
        },
      },
    },
  ...
  // آراء العملاء
  {
    id: 'eg-testimonials-grid',
    name: 'testimonials-egypt',
    nameAr: 'آراء العملاء المصريين',
    category: 'testimonials',
    activity: 'general',
    style: 'modern',
    wireframeType: 'testimonials',
    descriptionAr: 'بطاقات تقييمات العملاء مع نجوم وصورة المراجع.',
  ...
  // معرض صور
  {
    id: 'eg-photo-gallery',
    name: 'gallery-egypt',
    nameAr: 'معرض الصور والأعمال',
    category: 'gallery',
    activity: 'general',
    style: 'modern',
    wireframeType: 'gallery',
    descriptionAr: 'شبكة صور لعرض المنتجات أو الأعمال السابقة أو الأسطول.',
    ...
    nodes: {
      tmplt_gallery_root: {
        ...
        styles: {
          desktop: { backgroundColor: '#f8fafc', paddingTop: '64px', paddingBottom: '64px' },
          mobile: { paddingTop: '40px', paddingBottom: '40px' },
        },
      },
    },
  ...
  // إحصائيات
  {
    id: 'eg-stats-counter',
    name: 'stats-egypt',
    nameAr: 'إحصائيات وأرقام مقنعة',
    category: 'stats',
    activity: 'general',
    style: 'modern',
    wireframeType: 'stats',
    descriptionAr: 'أرقام تعبّر عن حجم وخبرة المتجر.',
  ...
  // أسئلة شائعة
  {
    id: 'eg-faq-section',
    name: 'faq-egypt',
    nameAr: 'الأسئلة الشائعة (FAQ مصري)',
    category: 'accordion',
    activity: 'general',
    style: 'clean',
    wireframeType: 'faq',
    descriptionAr: 'أسئلة مكررة بصياغة مصرية تناسب متاجر الإلكترونيات والملابس والطعام.',
  ...
  // قسم التواصل
  {
    id: 'eg-contact-section',
    name: 'contact-section-egypt',
    nameAr: 'قسم التواصل والحجز',
    category: 'contact',
    activity: 'general',
    style: 'modern',
    wireframeType: 'contact-section',
    descriptionAr: 'قسم تواصل مع هاتف وواتساب وبريد إلكتروني وعنوان من بيانات المتجر الحقيقية.',
    ...
    nodes: {
      tmplt_contact_root: {
        ...
        props: {
          ...
          subtitle: 'تواصل معنا بأي طريقة تناسبك وسنردّ عليك في أقرب وقت',
          phoneLabel: 'اتصل بنا',
  ...
  {
    id: 'eg-services-grid',
    name: 'services-grid-egypt',
    nameAr: 'شبكة الخدمات المقدّمة',
    category: 'features',
    activity: 'general',
    style: 'modern',
    wireframeType: 'services-grid',
    descriptionAr: 'عرض خدمات المتجر أو الشركة مع صور وأسعار وزر الحجز.',
  ...
  {
    id: 'eg-before-after',
    name: 'before-after-egypt',
    nameAr: 'عرض قبل وبعد',
    category: 'content',
    activity: 'general',
    style: 'split',
    wireframeType: 'before-after',
    descriptionAr: 'عرض مقارنة قبل/بعد مناسب للصالونات، الديكور، الصيانة.',
  ...
  // زر واتساب عائم
  {
    id: 'eg-whatsapp-float',
    name: 'whatsapp-float-egypt',
    nameAr: 'زر واتساب عائم',
    category: 'cta',
    activity: 'general',
    style: 'minimal',
    wireframeType: 'whatsapp-float',
    descriptionAr: 'زر واتساب ثابت في أسفل الصفحة يفتح محادثة مباشرة مع المتجر.',
