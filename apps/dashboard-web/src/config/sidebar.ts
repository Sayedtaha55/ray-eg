  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: Settings,
        href: '/dashboard/settings?tab=hr_settings&from=team',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        labelAr: 'إعدادات المخزون',
        icon: Package,
        href: '/dashboard/settings?tab=inventory_settings',
      },
      {
        id: 'settings_branches',
        label: 'Branches Settings',
        labelAr: 'إعدادات الفروع',
        icon: Building2,
        href: '/dashboard/settings?tab=branches_settings',
      },
      {
      ...
      },
      {
        ...
        labelAr: 'إعدادات المحاسبة',
        icon: Calculator,
        href: '/dashboard/settings?tab=accounting_settings',
      },
      {
        ...
        labelAr: 'إعدادات العملاء',
        icon: Users,
        href: '/dashboard/settings?tab=customers_settings',
      },
      {
        id: 'settings_crm',
        label: 'Customer Service Settings',
        labelAr: 'إعدادات خدمة العملاء',
        icon: Headset,
        href: '/dashboard/settings?tab=crm_settings',
      },
      {
        id: 'settings_hr',
        published: false,
        ...
        labelAr: 'إعدادات الفريق',
        icon: UserCog,
        href: '/dashboard/settings?tab=hr_settings',
      },
      {
        ...
        labelAr: 'إعدادات التحليلات',
        icon: BarChart3,
        href: '/dashboard/settings?tab=analytics_settings',
      },
      {
        id: 'settings_account',
        label: 'Account',
