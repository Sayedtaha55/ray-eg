...
export async function getOffersViaBackend(opts?: { take?: number; skip?: number; shopId?: string; shopCategory?: string }) {
  ...
  if (opts?.shopCategory) params.set('shopCategory', String(opts.shopCategory));
