...
const OfferCard: React.FC<OfferCardProps> = ({ offer, idx, navigate, setSelectedItem, playSound }) => {
  ...
  const disableExpensiveEffects = prefersReducedMotion || isLowEndDevice();
    ...
    >
      ...
      >
        <SmartImage
          ...
          imgClassName={`w-full h-full object-cover ${!disableExpensiveEffects ? 'group-hover:scale-110 transition-transform duration-[2s]' : ''}`}
        />
