  ...
  return (
    <div
      ...
      className={`group bg-white p-3 md:p-5 rounded-[2rem] md:rounded-[3rem] border border-slate-50 hover:shadow-[0_40px_80px_-20px_rgba(0,0,0,0.08)] transition-all duration-500 ${
        !prefersReducedMotion && !lowEnd ? 'transform transition-all duration-700' : ''
    ...
    >
      ...
      >
        <SmartImage
          ...
          imgClassName={`w-full h-full object-cover ${!lowEnd ? 'group-hover:scale-110 transition-transform duration-[2s]' : ''}`}
        />
