...
import {
  ...
  Mail, Phone, Facebook, ArrowUp, ChevronUp, Sparkles,
} from 'lucide-react';
          ...
          <section className="bg-white">
            <div className="max-w-7xl mx-auto px-5 sm:px-6 py-16 md:py-24">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-4">
                {[
                  { icon: Store, label: t('business.industries.generalStores') },
                  { icon: PackageCheck, label: t('business.industries.supermarket') },
                  { icon: Globe, label: t('business.industries.restaurants') },
                  { icon: Smartphone, label: t('business.industries.electronics') },
                  { icon: Users, label: t('business.industries.clinics') },
                  { icon: Shield, label: t('business.industries.pharmacies') },
                  { icon: Clock, label: t('business.industries.hotelBookings') },
                  { icon: Star, label: t('business.industries.fashion') },
                  { icon: BarChart3, label: t('business.industries.realEstate') },
                  { icon: Zap, label: t('business.industries.cars') },
                  { icon: Layout, label: t('business.industries.services') },
                  { icon: Sparkles, label: t('business.industries.other') },
                ].map((item, idx) => (
                  <div
                    key={idx}
                    className="flex items-center gap-3 p-4 md:p-5 bg-[#FAFAF7] rounded-2xl border border-slate-100 hover:border-[#00E5FF]/30 hover:bg-[#00E5FF]/5 transition-all"
                  >
                    <div className="text-[#0097A7] shrink-0">
...
const IndustryPill: React.FC<{ icon: React.ReactNode; label: string }> = ({ icon, label }) => (
  <div className="flex items-center gap-3 p-4 md:p-5 bg-[#FAFAF7] rounded-2xl border border-slate-100 hover:border-[#00E5FF]/30 hover:bg-[#00E5FF]/5 transition-all">
    <div className="text-[#0097A7] shrink-0">
      {icon}
    </div>
