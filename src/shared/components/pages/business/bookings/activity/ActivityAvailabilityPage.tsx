    ...
    <div className="space-y-5 text-right" dir="rtl">
      <div className="flex items-center justify-between flex-row-reverse">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl md:text-2xl font-black text-slate-900">التوافر الليلي</h2>
            <p className="text-xs text-slate-400 font-bold mt-0.5">اضغط على اليوم لتغيير حالته</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-3">
        <div className="bg-emerald-50 rounded-2xl p-4 text-center">
          ...
          <div className="text-xs font-bold text-emerald-600 mt-1">متاح</div>
        </div>
        <div className="bg-amber-50 rounded-2xl p-4 text-center">
          <div className="text-2xl font-black text-amber-700">{counts.booked}</div>
          <div className="text-xs font-bold text-amber-600 mt-1">محجوز</div>
        </div>
        <div className="bg-red-50 rounded-2xl p-4 text-center">
          <div className="text-2xl font-black text-red-700">{counts.blocked}</div>
          <div className="text-xs font-bold text-red-600 mt-1">مغلق</div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm p-6">
        <div className="flex items-center justify-between mb-5">
          <button type="button" onClick={nextMonth} title="الشهر التالي" className="p-2 rounded-xl hover:bg-slate-50"><ChevronLeft size={18} /></button>
          <h3 className="font-black text-slate-900 text-lg">{MONTHS[month]} {year}</h3>
          <button type="button" onClick={prevMonth} title="الشهر السابق" className="p-2 rounded-xl hover:bg-slate-50"><ChevronRight size={18} /></button>
        </div>
        ...
        <div className="flex items-center gap-4 justify-center mt-4 text-xs font-bold text-slate-500">
          <span className="flex items-center gap-1"><CheckCircle2 size={12} className="text-emerald-500" /> متاح</span>
          <span className="flex items-center gap-1"><MinusCircle size={12} className="text-amber-500" /> محجوز</span>
          <span className="flex items-center gap-1"><XCircle size={12} className="text-red-500" /> مغلق</span>
        </div>
      </div>
    </div>
  );
