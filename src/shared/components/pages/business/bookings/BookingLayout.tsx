...
const BookingDesignPage = React.lazy(() => import('./shared/BookingDesignPage'));
...
const BookingLayout: React.FC = () => {
  ...
  const vocab = getVocabulary(validActivity);
  ...
  const renderPage = () => {
    ...
    switch (activeTabParam) {
      ...
      case 'design':
        return <BookingDesignPage activityType={validActivity} />;
      case 'settings':
